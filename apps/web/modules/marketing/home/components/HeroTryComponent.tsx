...
export function HeroTryComponent() {
  ...
  const [selectedProduct, setSelectedProduct] = useState<Product>('humanizer');
    ...
    <div className="mx-auto mt-8 max-w-5xl">
      ...
      <div className="relative">
        ...
        <div className="absolute top-6 left-3 right-3 flex justify-between items-center z-10 px-3">
          {/* Title - Left Side */}
          <h3 className="text-lg font-semibold text-foreground">{tHero('tryItOut')}</h3>
          
          {/* Product Selection Dropdown - Right Side */}
          <Select
            value={selectedProduct}
            onValueChange={(value: Product) => setSelectedProduct(value)}
          >
